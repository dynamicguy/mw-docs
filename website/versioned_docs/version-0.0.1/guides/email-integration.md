---
id: version-0.0.1-email-integration
...
Then, set the environment variable `DEFAULT_FROM_EMAIL` [as mentioned before](/mw-docs/docs/guides/email-integration#default_from_email).
